...
<head>
    ...
    <title>StartBNS - Forex and Crypto Asset Managemente</title>
                            ...
                            <div class="col-12 col-lg-10 col-lg-offset-3 mx-auto">
                                <div class="pricing-trial-content d-flex justify-content-between">
                                    <div class="text-center text-md-left mt-3">
                                        <h3 class="text-primary">Start with your investment and earn daily!</h3>

                                        <button class="btn btn-primary mt-2 mt-lg-3">Start Earning</button>
                                    </div>
