<div class="modal-size-default d-inline-block">
    ...
    <!-- Modal -->
    <div class="modal fade text-left" id="useraddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <form  class="form-horizontal" method="POST"
                              action="{{ route('user-add1') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" readonly value="{{$child_left->user_name}}" name="placement_id" class="form-control"
                                             placeholder="Enter your phone Number" required/>
