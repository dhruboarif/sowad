<div class="modal-size-default d-inline-block">
    ...
    <!-- Modal -->
    <div class="modal fade text-left" id="useraddModal13" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <form  class="form-horizontal" method="POST"
                              action="{{ route('user-add14') }}" enctype="multipart/form-data">
                            @csrf
