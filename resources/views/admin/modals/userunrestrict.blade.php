            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="card-body">
                      ...
                      <form action="{{route('user-unrestrict')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{$row->id}}">

                        <h3>Are You Sure You Want to Unrestrict the User?</h3>
                ...
                <div class="modal-footer">
                  ...
                  <button type="Submit" class="btn btn-primary">UnRestrict</button>
                </div>
                  </form>
            </div>
        </div>
