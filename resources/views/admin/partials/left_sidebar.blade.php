<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('admin.pages.dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboard</span><span class="badge badge-light-warning badge-pill ml-auto mr-1"></span></a>

            </li>
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Apps &amp; Pages</span><i data-feather="more-horizontal"></i>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('package-manage')}}"><i data-feather='package'></i><span class="menu-title text-truncate" data-i18n="Email">Package</span></a>
            </li>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('withdraw-manage')}}"><i data-feather='shopping-cart'></i><span class="menu-title text-truncate" data-i18n="Email">Withdrawal Request</span></a>
              ...
              <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('rank-manage')}}"><i data-feather='grid'></i><span class="menu-title text-truncate" data-i18n="Email">Rank Bonus Request</span></a>
            </li>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center"><i data-feather='settings'></i><span class="menu-title text-truncate" data-i18n="Invoice">Settings</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="{{route('manage-bsettings')}}"><i data-feather='sliders'></i><span class="menu-item text-truncate" data-i18n="Preview">Basic Settings</span></a>
                      ...
                      <li><a class="d-flex align-items-center" href="{{route('manage-ranks')}}"><i data-feather='users'></i><span class="menu-item text-truncate" data-i18n="Preview">Rank Settings</span></a>
                    </li>
                     <li><a class="d-flex align-items-center" href="{{route('club-settings')}}"><i data-feather='tool'></i><span class="menu-title text-truncate" data-i18n="Email">Club Settings</span></a>
            </li>

                </ul>
            </li>
              <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('balance-adjust')}}"><i data-feather='credit-card'></i></i><span class="menu-title text-truncate" data-i18n="Email">Balance Adjust</span></a>
            </li>
              
            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('club-members')}}"><i data-feather='users'></i><span class="menu-title text-truncate" data-i18n="Email">Club Members</span></a>
            </li>
