     ...
     */
     public function handle()
     {
         ...
         $results= User::all();
           ...
           $bonus_am= $g_set->pair_amount*($g_set->pair_percentage/100);
           //dd($bonus_am);
         ...
         foreach ($results as $key => $result) {
           ...
           $right_count= $result->right_active;
             ...
             if ($left_count != 0 && $right_count !=0 ) {
                 ...
                 if ($check_pair_availability <= $g_set->capping_pair_limit){
                    $amount= $check_pair_availability;
                 }else{
                     $amount = $g_set->capping_pair_limit;
                 }
                   ...
                   $bonus_amount->bonus_amount = $amount * $bonus_am;
